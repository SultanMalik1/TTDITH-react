    ...
    <nav className="border-b border-gray-200 w-full bg-white">
      <div className="flex justify-between items-center py-4 px-6">
        ...
        <div className="hidden lg:flex gap-2 items-center">
          <Link
            to="/list-event"
            className="border border-gray-300 px-3 py-1 rounded hover:bg-gray-50 transition text-gray-700 text-sm"
          >
            List a Thing
          </Link>
          <Link
            to="/sponsor"
            className="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition font-semibold text-sm"
          >
            Become a Sponsor
          </Link>
        </div>
