    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Want to promote your business and events in the Hamptons with actual
          results? We're more than just a local guide—we're your seasonal
          marketing partner.
        </p>
      </div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span className="text-gray-700">
                <strong>Listing:</strong> Your business name featured on our
                platform.
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-2 text-green-500">✓</span>
              <span className="text-gray-700">
                <strong>Badge:</strong> A special sponsor badge to highlight
                your support.
              </span>
            </li>
          </ul>
        ...
        <div className="p-6 rounded-2xl shadow-lg transition-all hover:shadow-xl bg-white border border-gray-200">
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              <span className="mr-2 text-green-500">✓</span>
              <span className="text-gray-700">
                <strong>Includes all features of Cottage Sponsor</strong>
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-2 text-green-500">✓</span>
              <span className="text-gray-700">
                20% off all advertisements throughout the month
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-2 text-green-500">✓</span>
              <span className="text-gray-700">
                Enhanced exposure with a featured spot
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="p-6 rounded-2xl shadow-lg transition-all hover:shadow-xl bg-gradient-to-br from-blue-50 to-blue-100 border border-gray-200">
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              <span className="mr-2 text-green-500">✓</span>
              <span className="text-gray-700">
                <strong>Includes all features of Bayfront Sponsor</strong>
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-2 text-green-500">✓</span>
              <span className="text-gray-700">
                Two free ads per month (2 days each)
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-2 text-green-500">✓</span>
              <span className="text-gray-700">
                Event uploads to top Hamptons platforms:
              </span>
            </li>
        ...
        {showThankYou && (
          ...
          >
            ...
            <p className="text-green-700">
              We've received your sponsorship interest and will get back to you
              shortly.
            </p>
          </div>
        )}
